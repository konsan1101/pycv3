...
SET profile_id=43d2d2c9-62b3-44d0-b5d9-db75439aeec7
SET profile_name=kondou
...
ECHO ■プロフィール音声登録■
ECHO %profile_name%
python Identification\EnrollProfile.py %subscription_key% %profile_id% ../temp/temp_voice_kondou_info.wav True
python Identification\EnrollProfile.py %subscription_key% %profile_id% ../temp/temp_voice_kondou_info2.wav True
python Identification\EnrollProfile.py %subscription_key% %profile_id% ../temp/temp_voice_kondou_short.wav True
python Identification\EnrollProfile.py %subscription_key% %profile_id% ../temp/temp_voice_kondou_short2.wav True
