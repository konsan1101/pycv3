...
SET profile_id=b3a1fb87-0ff4-4550-917d-7e74e83adf00
SET profile_name=minabe
...
ECHO ■プロフィール音声登録■
ECHO %profile_name%
python Identification\EnrollProfile.py %subscription_key% %profile_id% ../temp/temp_voice_minabe_info.wav True
python Identification\EnrollProfile.py %subscription_key% %profile_id% ../temp/temp_voice_minabe_short.wav True
